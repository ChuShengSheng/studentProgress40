...
<main class="main">
    ...
    <h3 class="heading-secondary">Для того, что бы отредактировать новую дисциплину заполните все поля и нажмите кнопку
        "Применить":</h3>
    <br>
    <form action="/discipline-modify" method="post">
        ...
        <div class="name-window">
            ...
            <input name="discipline" type="text" id="discipline" value="${discipline.discipline}">
        </div>
        <br>
